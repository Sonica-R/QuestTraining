...
/*INSERT INTO transactions (transaction_id, from_account, transfer_date, transaction_type, account_id, to_account, transaction_amount) VALUES
...
/*SELECT account.account_id as acc_id, account.account_name as acc_name, transactions.transaction_id as transac_id, transactions.transaction_type as transac_type, transactions.transfer_date as [date] from 
account 
INNER JOIN 
transactions
